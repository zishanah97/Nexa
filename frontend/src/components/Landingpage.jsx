      ...
      <main className="relative z-10 w-full flex flex-col items-center justify-center px-4 sm:px-8 xl:px-0 text-center py-20 lg:py-32 min-h-[80vh]">
        <div className="w-full max-w-5xl mx-auto flex flex-col gap-8 items-center">
          ...
          <h1 className="w-full flex flex-col lg:flex-row items-center lg:items-baseline justify-center text-center gap-y-0 gap-x-4 mb-0">
            ...
            <span
              className="
          bg-gradient-to-b from-orange-700 via-orange-500 to-yellow-400
        ...
        "
          ...
          {/* Subheading */}
          <h2
            className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight  bg-gradient-to-b from-neutral-900 via-neutral-700 to-neutral-500
          bg-clip-text text-transparent"
            style={{
          ...
          >
            Built in <span className="text-orange-600    bg-gradient-to-b from-orange-700 via-orange-500 to-yellow-400
          bg-clip-text text-transparent">60</span> Seconds
          </h2>
          ...
          <div className="flex justify-center pt-10 md:pt-12">
            <NavLink to="/home">
              <button
                className="inline-flex items-center gap-3 bg-black text-white px-8 md:px-12 py-4 md:py-5 rounded-full text-lg md:text-xl font-semibold shadow-xl hover:bg-gray-800 hover:shadow-2xl transition-all transform active:scale-98 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 relative overflow-hidden cursor-pointer"
                style={{
