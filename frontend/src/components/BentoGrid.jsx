...
// Make sure all these fonts are imported globally in your app.
const features = [
  {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {features.map((item, i) => (
            ...
            >
              {/* Aspect Ratio Container for perfect grid */}
              <div className="relative w-full aspect-[4/5] bg-gray-100">
                ...
                {/* Card Text */}
                <div className="absolute bottom-0 left-0 w-full px-6 pb-7 pt-5 z-20 flex flex-col">
                  <h3
