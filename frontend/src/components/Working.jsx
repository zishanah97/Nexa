  ...
  return (
    <section className="w-full py-20 px-4 lg:px-6 z-10">
      <div className="max-w-6xl mx-auto text-center mb-14">
        ...
        >
          From <span className="font-bold text-orange-600" style={{ fontFamily: '"Playfair Display", serif' }}>your travel idea</span> to a <span className="font-bold text-orange-600" style={{ fontFamily: '"Playfair Display", serif' }}>dream itinerary</span> — automated
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-6xl mx-auto">
        {steps.map((step, i) => (
          <div
            key={i}
            className="relative bg-white/95 backdrop-blur-2xl rounded-3xl border border-orange-100 shadow-xl lg:shadow-2xl flex flex-col items-center px-5 md:px-8 py-10
              hover:-translate-y-1 hover:shadow-orange-200/40 transition-transform group"
            style={{
              boxShadow:
          ...
          >
            {/* Floating Icon with glow and soft drop shadow */}
            ...
            {/* Step Number Badge - with warm shadow */}
            ...
            {step.bullets && (
              <ul className="bg-orange-50/90 border border-orange-100 shadow-sm rounded-2xl px-6 py-4 mt-2 space-y-2 w-full max-w-xs mx-auto text-gray-900 text-sm text-left" style={{ fontFamily: '"Inter", sans-serif' }}>
